...
#Ler os dados via Excel
divida <- read_excel("Divggnp1.xls", col_types = 'numeric')

# Tratar DADOS #
divida <- t(divida[-c(1:8, 54:67),-c(1:2)])
divida <- ts(divida, start=c(2006,12), freq=12)

# Rotular
colnames(divida) <- c(1:45)
dbgg <- divida[,c(3)] #divida bruta do governo geral

date <- seq(as.Date('2006-12-01'),to=as.Date("2017-02-01"),by='1 month')
...
# Grafico da Serie
ggplot(data=dbgg2) +
  geom_line(aes(x=date, y=dbgg), colour="darkblue", size=1.5) +
  xlab('Anos') + ylab('% PIB') +
  ggtitle('Trajetoria da Divida Bruta do Brasil')
...
data2 <- c("Setembro/2016", "Outubro/2016", "Novembro/2016", 
           "Dezembro/2016", "Janeiro/2017", "Fevereiro/2017")
